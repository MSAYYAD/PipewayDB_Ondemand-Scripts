...
if($date==$fileR[0]){ 
    ...
    $mailfire->Password = 'Goolean@122018#';                           
    $mailfire->SMTPSecure = 'tls';                           
    $mailfire->Port = 587;  
    $mailfire->From = 'donotreply@aacanet.org';   
    $mailfire->FromName = 'CRONWEEKLY BIDEV script notification';
    $mailfire->addAddress('puja.kumari@goolean.tech');
